...
/**
 * Integration tests for UserService gRPC APIApiClient
 * These tests require a running API server
 * Generated by SDK Generator
 */
@DisplayName("UserService gRPC API API Integration Tests")
@EnabledIfSystemProperty(named = "integration.tests.enabled", matches = "true")
public class UserService gRPC APIIntegrationTest {
